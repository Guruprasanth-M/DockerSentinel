...
async def process_scores(client: aioredis.Redis, engine: PolicyEngine, loader: PolicyLoader):
...
async def main() -> None:
    logger.info("policy_engine_starting", version="0.1.0", redis_url=REDIS_URL)
    ...
    tasks = [
        ...
        asyncio.create_task(process_scores(client, engine, loader)),
    ]
